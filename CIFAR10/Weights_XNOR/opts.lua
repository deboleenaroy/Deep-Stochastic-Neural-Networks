...
function M.parse(arg)
    ...
    cmd:option('-testCache', './cache/testCache.t7', 'subdirectory in which to save/log experiments')
    cmd:option('-trainCache', './cache/trainCache.t7', 'subdirectory in which to save/log experiments')
    cmd:option('-data', './dataset/', 'Home of ImageNet dataset')
    cmd:option('-dataset',  'cifar', 'Dataset Name: imagenet |cifar')
